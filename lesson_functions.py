...
#
# def extract_single_image_hog_features(img, orient=9, pix_per_cell=8,
...
#
#
# def extract_single_img_features(img, cspace='RGB', spatial_size=(32, 32),
...
#
#   hog_features = extract_single_image_hog_features(feature_image, orient, pix_per_cell,
...
def extract_features(imgs, cspace='RGB', spatial_size=(32, 32),
  ...
  for file in imgs:
    ...
    # single_img_features_display(image, cspace, spatial_size, hist_bins, orient,
    #                     pix_per_cell, cell_per_block, 0)
    # image = image * 255
    features.append(
      single_img_features(image, cspace, spatial_size, hist_bins, orient,
...
def single_img_features_display(img, color_space='RGB', spatial_size=(32, 32),
                                hist_bins=32, orient=9,
                                pix_per_cell=8, cell_per_block=2, hog_channel=0):
  # 1) Define an empty list to receive features
  img_features = []
  ...
  im_resized = cv2.resize(feature_image, (32, 32))

  fig = plt.figure()
  plt.subplot(241)
  plt.imshow(feature_image[:, :, 0], cmap='gray')
  plt.title('Car Image CH-1')
  plt.subplot(242)
  plt.imshow(feature_image[:, :, 0], cmap='gray')
  plt.title('Car Image CH-1')
  plt.subplot(243)
  plt.imshow(feature_image[:, :, 1], cmap='gray')
  plt.title('Car Image CH-2')
  plt.subplot(244)
  plt.imshow(feature_image[:, :, 2], cmap='gray')
  plt.title('Car Image CH-3')
  plt.subplot(245)
  plt.imshow(hog_image, cmap='gray')
  plt.title('Car Image CH-1 HOG')
  plt.subplot(246)
  plt.imshow(im_resized[:, :, 0], cmap='gray')
  plt.title('Spatial Features CH-1')
  plt.subplot(247)
  plt.imshow(im_resized[:, :, 1], cmap='gray')
  plt.title('Spatial Features CH-2')
  plt.subplot(248)
  plt.imshow(im_resized[:, :, 2], cmap='gray')
  plt.title('Spatial Features CH-3')
  fig.tight_layout()


def find_cars(img, color_space, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size,
              hist_bins, hog_img):
...
def search_windows(img, windows, clf, scaler, color_space='RGB',
  ...
  for window in windows:
    ...
    # single_img_features_display(test_img, color_space='YUV',
